...
# PostgreSQL pour la production (commenté pour le moment)
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': os.getenv('DB_NAME', 'avipro_db'),
...
# Si tu veux autoriser toutes les origines pour le développement (optionnel)

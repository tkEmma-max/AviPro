...
# Database - PostgreSQL pour Render, SQLite pour le développement
...
# En production, autoriser l'URL de Render
if os.getenv('RENDER'):
    CORS_ALLOWED_ORIGINS.append('https://avipro-backend.onrender.com')
